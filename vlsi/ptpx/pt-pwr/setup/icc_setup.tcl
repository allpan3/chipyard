...
set ICC_MACRO_FPCK_CEL           "macro_fp_check_icc"
...
set ICC_ECO_STARTING_CEL	 $ICC_CHIP_FINISH_CEL         ;# CEL to run ECO on (contains original pre-tape-out database)
...
set ICC_APPLY_RM_UNCERTAINTY_PRECTS     TRUE	;# TRUE|FALSE; when set to TRUE, user uncertainty will be replaced by $ICC_UNCERTAINTY_PRECTS
set ICC_APPLY_RM_UNCERTAINTY_POSTCTS    TRUE	;# TRUE|FALSE; when set to TRUE, user uncertainty will be replaced by $ICC_UNCERTAINTY_POSTCTS
...
set ICC_IN_FLOORPLAN_USER_FILE	  	"floorplan_overview.tcl"	;# Complete floorplan file generated by user ;this file will simply be sourced
...
set CUSTOM_CONNECT_PG_NETS_SCRIPT 	"derive_pg.tcl"      ;# If not defined as "", source this file
...
#set ICC_CTS_LAYER_LIST		"M7 M8"	;# clock tree layers, usually M3 and above
set ICC_CTS_LAYER_LIST		"M7 M8"	;# clock tree layers, usually M3 and above
						;# e.g. set ICC_CTS_LAYER_LIST "M3 M4 M5"
set ICC_CTS_REF_LIST		"CKBD12BWP35LVT CKND12BWP35LVT"		;# cells ;# used for CTS
						;#   space deliminated list: cell1 cell2
set ICC_CTS_REF_DEL_INS_ONLY	"CKBD12BWP35LVT CKND12BWP35LVT"		;# cells for CTS delay insertion :
						;#   space deliminated list: cell1 cell2
          # [get_lib_cells tcbn28hpmbwp35*/CK*]
set ICC_CTS_REF_SIZING_ONLY		"CKAN2D0BWP35LVT CKAN2D1BWP35LVT CKAN2D2BWP35LVT CKAN2D4BWP35LVT CKAN2D8BWP35LVT CKBD0BWP35LVT CKBD12BWP35LVT CKBD16BWP35LVT CKBD1BWP35LVT CKBD20BWP35LVT CKBD24BWP35LVT CKBD2BWP35LVT CKBD3BWP35LVT CKBD4BWP35LVT CKBD6BWP35LVT CKBD8BWP35LVT CKLHQD12BWP35LVT CKLHQD16BWP35LVT CKLHQD1BWP35LVT CKLHQD20BWP35LVT CKLHQD24BWP35LVT CKLHQD2BWP35LVT CKLHQD3BWP35LVT CKLHQD4BWP35LVT CKLHQD6BWP35LVT CKLHQD8BWP35LVT CKLNQD12BWP35LVT CKLNQD16BWP35LVT CKLNQD1BWP35LVT CKLNQD20BWP35LVT CKLNQD24BWP35LVT CKLNQD2BWP35LVT CKLNQD3BWP35LVT CKLNQD4BWP35LVT CKLNQD6BWP35LVT CKLNQD8BWP35LVT CKLNQOPTMAD16BWP35LVT CKLNQOPTMAD1BWP35LVT CKLNQOPTMAD2BWP35LVT CKLNQOPTMAD4BWP35LVT CKLNQOPTMAD8BWP35LVT CKMUX2D0BWP35LVT CKMUX2D1BWP35LVT CKMUX2D2BWP35LVT CKMUX2D4BWP35LVT CKND0BWP35LVT CKND12BWP35LVT CKND16BWP35LVT CKND1BWP35LVT CKND20BWP35LVT CKND24BWP35LVT CKND2BWP35LVT CKND2D0BWP35LVT CKND2D1BWP35LVT CKND2D2BWP35LVT CKND2D3BWP35LVT CKND2D4BWP35LVT CKND2D8BWP35LVT CKND3BWP35LVT CKND4BWP35LVT CKND6BWP35LVT CKND8BWP35LVT CKXOR2D0BWP35LVT CKXOR2D1BWP35LVT CKXOR2D2BWP35LVT CKXOR2D4BWP35LVT"	;# cells for CTS that are for sizing only
...
set_message_info -id DPI-020  -limit 10 ;# tap cell is phys only
#set_message_info -id PGRT-030 -limit 10 ;# power plan blockage
#set_message_info -id PGRT-046 -limit 10 ;# power plan blockage
suppress_message PGRT-030
suppress_message PGRT-046
...
proc elapsed_time {start} {
  set end [clock seconds]
  set tdiff [expr $end - $start]
  set tstring [clock format $tdiff -format {%H:%M:%S} -gmt true]
  puts [format "Elapsed Time: %8s" $tstring]
}
...
set ICC_ECO_FLOW_TYPE   "pt_hold_fixing_tcl" ;# verilog | pt_drc_setup_fixing_tcl | pt_hold_fixing_tcl | pt_minimum_physical_impact - specify type of ECO file for UNCONSTRAINED ICC_ECO_FLOW;
...
set ICC_MCMM_FLOORPLAN_SCENARIOS        ""     	;# list of scenarios to be made active during place_opt; optional; by default all scenarios will be made active
...
set ICC_MCMM_CLOCK_OPT_CTS_SCENARIOS   ""     	;# list of scenarios to be made active during post-CTS optimization (pre-route); optional; by default all scenarios will be made active
